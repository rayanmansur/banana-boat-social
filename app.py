...
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgres://innrptxbcakyko:fd8777b6d61a30f6487d0ecd237b067c009a88067aa9d86c133e655ec576322b@ec2-54-208-139-247.compute-1.amazonaws.com:5432/d68add4h5ogos'

# New MYSQL db
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:1234@localhost/our_users'

# Secret Key!
app.config['SECRET_KEY'] = "amoguspan"
